  ...
  return (
    <>
      ...
      <div className="shell about-grid">
        <div className="about-portrait"><Image src="/images/landed/fayfay.jpg" alt="FayFay, founder of FAYFORT International Trading" fill sizes="(max-width: 900px) 100vw, 40vw" style={{ objectFit: 'cover', objectPosition: '50% 25%' }} /></div>
        <div className="prose">
          <h2>Who we are</h2>
      ...
      <section className="contents-section"><div className="shell section-space prose-page">
        ...
        <div className="audience-grid">
          ...
          ].map(([title, copy]) => <article className="inside-card" key={title}><h3>{title}</h3><p>{copy}</p></article>)}
        </div>
      </div></section>
