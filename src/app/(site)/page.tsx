    ...
    <div className="hub">
      ...
      <section className="hub-hero"><div className="shell hub-hero-grid">
        <div className="hub-hero-copy">
          <p className="hub-name"><Image src="/images/fay/butterfly.png" alt="" width={34} height={30} priority /> FayFay</p>
          <h1>Between China’s factories and <em>Africa’s businesses.</em></h1>
          <p className="page-lede">I’ve lived in China for eight years. I source, inspect and ship for importers in Nigeria, Zimbabwe, South Africa, the UK and the US, and I wrote the directory I wish I’d had when I started.</p>
          ...
          <p className="hub-role">Founder, FAYFORT International Trading · Author, LANDED</p>
        </div>
      ...
      <section className="shell section-space">
        <div className="section-kicker"><p>Three ways in</p></div>
        <div className="doors">
          <Link className="door" href="/services">
          ...
          <Link className="door door-landed" href="/ebook/landed">
      ...
      <section className="dark-section"><div className="shell section-space">
        <div className="section-kicker light"><p>On the record</p></div>
      ...
      <section className="shell section-space hub-story">
        ...
        <ol className="milestones">
          {milestones.map(([year, text]) => <li key={year}><span>{year}</span><p>{text}</p></li>)}
        </ol>
      </section>
      ...
      <section className="contents-section"><div className="shell section-space">
        ...
        <div className="editorial-row">
          ...
          ].map(([file, alt]) => <div className="editorial-image" key={file}><Image src={`/images/fay/${file}`} alt={alt} fill sizes="(max-width: 700px) 100vw, 33vw" style={{ objectFit: 'cover' }} /></div>)}
        </div>
      </div></section>
